# Installation
## Bootstrap
yarn create react-app redux-first
...
Webpack will set anything in a .env or .env.production into Node Environment variables.
...
It will render the component "App" to the <div id="root"></div> on DOM.
* `ReactDOM.render(<App />, document.getElementById('root'));`
App extends a Component and the render() returns a template. 

## Global State Object
Create a state variable in entry point file: index.js   const state = {}; and pass it over to the props of a Component
* `ReactDOM.render(<App todos={state.todo_list}/>, document.getElementById('root'));` *
State is available via `this.props`.

## Redux Store
yarn add redux
touch ./src/store.js
We dispatch actions to the store wich returns new objects/arrays

### Redux DevTools Extension
npm install redux-devtools-extension --save-dev

### Redux Store (with Async)
Install middleware redux-thunk
npm install redux-thunk --save

## Data Sharing Methhod 1
Passing the data from App down through the component tree via "props"
* Passing props *
```
...
## Data Sharing Methhod 2
yarn add react-redux / npm install react-redux --save
import {Provider} from 'react-redux';
Connecting each component to redux for individual rendering

### How to add Redux data structuring to a component
1. Create and export a reducer function /reducers/my_reducer.js
  const messageReducer = (state, action) => {...}
2. Import that reducer in the store.js and combined with other reducers if needed
3. Connect the Component to redux

### When one action is dispatched all reducers are notified
On the switch case logic of another reducer, add a new case for the neighbor action that you want to listen
  case OTHER_ACTION:
      return '';

## Components are Stateless Functional Components (JSX)

## React Router
1. Component MyRouter
<Link to="/"> All </Link>

2. Import router and Component on App.js
import {BrowserRouter as Router} from 'react-router-dom';

3. Add the component tag on the render tree main node 
